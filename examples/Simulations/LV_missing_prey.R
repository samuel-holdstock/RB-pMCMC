...
# Missing prey
obs_list_noise = as.matrix(obs_list[,2])

plot_RB_MJP("LV",x,theta,tout_list,lower_list,upper_list,tau_list,obs_list,10,c('Prey','Predator'),c('blue','red'),c(0,500))

boot1 = replicate(500,RB_particle_filter("LV",x,theta,tout_list,lower_list,upper_list,tau_list,obs_list_noise,500))
boot2 = replicate(500,RB_particle_filter("LV",x,theta,tout_list,lower_list,upper_list,tau_list*0,obs_list_noise,500))
