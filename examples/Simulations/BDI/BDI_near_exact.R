...
d = RB_particle_filter_debug("LV",x,theta,tout_list,lower_list,upper_list,tau_list,obs_list,100)

microbenchmark(
  A={RB_particle_filter("LV",x,theta,tout_list,lower_list,upper_list,tau_list,obs_list,100)},
  B={RB_particle_filter2("LV",x,theta,tout_list,lower_list,upper_list,tau_list,obs_list,100)},
  C={frac_particle_filter("LV",x,theta,tout_list,obs_list,100)},
  D={frac_particle_filter2("LV",x,theta,tout_list,obs_list,100)},
  unit='ms',times=1000
)
