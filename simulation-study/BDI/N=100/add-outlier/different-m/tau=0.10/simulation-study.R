...
### M = 10
pdf("simulation-study/BDI/N=100/add-outlier/different-m/tau=0.10/M=10.pdf")
M = 10
...
### M = 100
pdf("simulation-study/BDI/N=100/add-outlier/different-m/tau=0.10/M=100.pdf")
M = 100
...
### M = 1000
pdf("simulation-study/BDI/N=100/add-outlier/different-m/tau=0.10/M=1000.pdf")
M = 1000
