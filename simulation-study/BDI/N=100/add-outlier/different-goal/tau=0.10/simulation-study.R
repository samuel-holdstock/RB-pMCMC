...
### goal = 0.90
pdf("simulation-study/BDI/N=100/add-outlier/different-goal/tau=0.10/goal=0_90.pdf")
goal = 0.90
...
### goal = 0.95
pdf("simulation-study/BDI/N=100/add-outlier/different-goal/tau=0.10/goal=0_95.pdf")
goal = 0.95
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
upper_list = box$upper
...
### goal = 0.99
pdf("simulation-study/BDI/N=100/add-outlier/different-goal/tau=0.10/goal=0_99.pdf")
goal = 0.99
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
upper_list = box$upper
