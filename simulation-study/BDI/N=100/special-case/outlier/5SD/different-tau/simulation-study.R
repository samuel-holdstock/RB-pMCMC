source("examples/Parameters/BDI/Equilibrium (outlier 5SD).R")
...
### tau = 0.10
pdf("simulation-study/BDI/N=100/special-case/outlier/5SD/different-tau/tau=0_10.pdf")
tau = 0.10
...
### tau = 0.30
pdf("simulation-study/BDI/N=100/special-case/outlier/5SD/different-tau/tau=0_30.pdf")
tau = 0.30
subtitle = paste('tau =',tau)
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
...
### tau = 0.60
pdf("simulation-study/BDI/N=100/special-case/outlier/5SD/different-tau/tau=0_60.pdf")
tau = 0.60
subtitle = paste('tau =',tau)
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
