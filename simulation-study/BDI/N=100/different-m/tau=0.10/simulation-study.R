...
### M = 10
pdf("simulation-study/BDI/N=100/different-m/tau=0.10/M=10.pdf")
M = 10
subtitle = paste('M =',M)
...
### M = 100
pdf("simulation-study/BDI/N=100/different-m/tau=0.10/M=100.pdf")
M = 100
subtitle = paste('M =',M)
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
...
### M = 1000
pdf("simulation-study/BDI/N=100/different-m/tau=0.10/M=1000.pdf")
M = 1000
subtitle = paste('M =',M)
box = get_box("BDI",theta,tout_list,tau,x,obs_list,goal)
lower_list = box$lower
