source("examples/Parameters/BDI/Drift (N=100).R")
...
### M = 10
pdf("simulation-study/BDI/N=100/add-drift/different-m/tau=0.30/M=10.pdf")
M = 10
...
plot_study_estimates_M(rb_sims,frac_sims,0.003,0.95)
plot_study_estimates_M_time(rb_sims,frac_sims,30)
dev.off()

### M = 100
pdf("simulation-study/BDI/N=100/add-drift/different-m/tau=0.30/M=100.pdf")
M = 100
...
### M = 1000
pdf("simulation-study/BDI/N=100/add-drift/different-m/tau=0.30/M=1000.pdf")
M = 1000
...
plot_RB_MJP("BDI",x,theta,tout_list,lower_list,upper_list,tau,obs_list,30,c("Population"),c("blue"),c(50,150))
plot_study_estimates_M(rb_sims,frac_sims,0.0005,0.99)
plot_study_estimates_M_time(rb_sims,frac_sims,30)
dev.off()
